...
public class site_sistema {
	...
	public void test_2() throws InterruptedException {
		//Editar a primeira reportagem
				...
				txtTituloN.sendKeys("Novo Corona vírus");
	...
	@Test
	//quarto teste, clicar no botão de notícias, utilizar o campo de pesquisa e pesquisar o titulo da primeira noticia
	public void test_4() throws InterruptedException{
		...
		txtPesquisa.sendKeys("Novo corona vírus");
